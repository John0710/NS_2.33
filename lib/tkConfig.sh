...
# build directory.
TK_BUILD_LIB_SPEC='-L/usr/local/NS_2.33/tk8.4.18/unix -ltk8.4'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/usr/local/NS_2.33/lib -ltk8.4'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/usr/local/NS_2.33/include'
...
# compiled.
TK_SRC_DIR='/usr/local/NS_2.33/tk8.4.18'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/usr/local/NS_2.33/tk8.4.18/unix -ltkstub8.4'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/usr/local/NS_2.33/lib -ltkstub8.4'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/usr/local/NS_2.33/tk8.4.18/unix/libtkstub8.4.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/usr/local/NS_2.33/lib/libtkstub8.4.a'
